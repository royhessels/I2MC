function [finalweights,stopped] = twoClusterWeighting2(xpos,ypos,missing,windowtime,steptime,freq,maxerrors)
...
while eind<=length(xpos)
    ...
    if 0    % debug plot (continues below)
